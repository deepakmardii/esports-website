      ...
      <div className="p-5 mx-auto sm:p-10 md:p-0 dark:bg-gray-800 dark:text-gray-100">
        <div className="flex flex-col overflow-hidden font-mono">
          <img
            ...
            alt=""
            className="w-full h-60 sm:h-[70vh] dark:bg-gray-500"
          />
        </div>
      </div>
      <section className="dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col-reverse mx-auto lg:flex-row h-[100vh] justify-center items-center">
...
<section className="p-4 lg:p-8 dark:bg-gray-800 dark:text-gray-100">
    <div className="text-5xl font-bold pb-10 text-center">
    ABOUT THE TEAM
    </div>
