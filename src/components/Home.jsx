...
const Home = () => {
  return (
    <div>
      <div className="p-5 mx-auto sm:p-10 md:p-0 dark:bg-gray-800 dark:text-gray-100">
        <div className="flex flex-col overflow-hidden font-mono">
          <img
            src="https://source.unsplash.com/random/480x360"
            alt=""
            className="w-full h-60 sm:h-screen dark:bg-gray-500"
          />
          <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-900 self-center">
            ...
            <div className="dark:text-gray-100">
              <p>
                Velocity Gaming was started in 2019 by Manoj “Sentinel” Kasyap ,
                we are one of the most popular eSports brands in India , from
                being undefeated a whole year to being the first Indian team to
                represent India at global stage . Today well-driven by the
                passion of our owner as well as the growing fanbase , we’re
                becoming India’s biggest Esports organization.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-900">
        ...
        <img
          ...
          alt=""
          className="w-5/6 mx-auto mt-20 shadow-md lg:mt-20 dark:bg-gray-500"
        />
      </section>
